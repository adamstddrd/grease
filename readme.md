...
* **💅 a simple and powerful CSS architecture** - Grease ships with [a tiny, opinionated CSS architecture](https://naughty-hamilton-fd6478.netlify.app) that blends styled defaults and a handful of functional CSS systems to handle most of your CSS layout needs. Page/section-specific stylesheets ensure a tiny per-page CSS footprint, even for very large sites.
